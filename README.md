...
-   **BlockUserAgent**: Filters requests by matching the `User-Agent` string against a configurable list of substrings. This can be used to block scrapers, bots, or other unwanted clients.
