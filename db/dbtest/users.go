...
func (s UsersSuite) TestUserLifecycle(t *testing.T) {
	testDB := s.Db
...
func (s UsersSuite) TestUser_EdgeCases(t *testing.T) {
	testDB := s.Db
...
func (s UsersSuite) RunAll(t *testing.T) {
	s.TestUserLifecycle(t)
	s.TestUser_EdgeCases(t)
}
